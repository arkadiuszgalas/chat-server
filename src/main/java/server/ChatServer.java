...
import sound.ServerAudioPlayer;
...
public class ChatServer implements Runnable {
    ...
    public final static String DEFAULT_HOST_FILE = "H:\\java.sl-275\\chat-server\\src\\main\\resources\\hosts.txt";
    ...
    private ServerAudioPlayer audioPlayer;
    ...
    public void go()
    {
        ...
        try {
            audioPlayer = new ServerAudioPlayer();
